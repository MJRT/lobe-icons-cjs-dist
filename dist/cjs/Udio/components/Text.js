...
var Icon = (0, import_react.memo)(({ size = "1em", style, ...rest }) => {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M36.466 5.96l-4.09 1.011v12.285h4.09V5.96zM32.215 2.36c0-1.247.935-2.229 2.219-2.229 1.283 0 2.192.982 2.192 2.23 0 1.247-.909 2.228-2.192 2.228-1.284 0-2.219-.98-2.219-2.229z" }),
    /* @__PURE__ */ React.createElement(
      "path",
      {
        clipRule: "evenodd",
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M8.656 15.942c1.23 0 1.978-.796 1.978-2.15V6.365h4.09v7.455c0 3.068-2.03 5.27-5.064 5.663l-3.57-3.541h2.566zM6.09 15.942V20L2 15.942h4.09zM6.09 6.365v9.577L2 11.882V6.365h4.09z" })
  );
});

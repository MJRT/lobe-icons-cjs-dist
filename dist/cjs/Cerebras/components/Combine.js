...
// src/Cerebras/components/Combine.tsx
var Combine_exports = {};
...
var import_BrandColor = __toESM(require("./BrandColor"));
var import_BrandMono = __toESM(require("./BrandMono"));
var Combine = (0, import_react.memo)(({ type = "mono", ...rest }) => {
  const Icon = type === "color" ? import_BrandColor.default : import_BrandMono.default;

...
var ModelIcon_exports = {};
__export(ModelIcon_exports, {
  default: () => ModelIcon_default
});
module.exports = __toCommonJS(ModelIcon_exports);
...
var ModelIcon = (0, import_react.memo)(
  ({ model: originModel, size = 12, type = "avatar", shape, ...rest }) => {
    ...
    const Render = (0, import_react.useMemo)(() => {
      ...
      for (const item of import_modelConfig.modelMappings) {
...
var ModelIcon_default = ModelIcon;

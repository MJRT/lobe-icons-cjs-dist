...
var Icon = (0, import_react.memo)(({ size = "1em", style, ...rest }) => {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M19.408 6.051a49.571 49.571 0 01-2.53-3.567.845.845 0 00-.336-.361A.93.93 0 0016.08 2h-1.77a.93.93 0 00-.814.428 40.853 40.853 0 01-2.516 3.5A22.752 22.752 0 018.216 8.8l1.172 1.451c1.052-.851 2.078-1.896 3.045-3.106.945-1.182 1.733-2.263 2.342-3.213l.052-.08h.71l.05.078c1.934 2.895 3.717 5.022 5.297 6.323l1.193-1.451a17.713 17.713 0 01-2.673-2.749l.004-.002z" }),

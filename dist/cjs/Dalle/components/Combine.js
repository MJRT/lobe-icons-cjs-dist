...
// src/Dalle/components/Combine.tsx
var Combine_exports = {};
...
var import_Mono = __toESM(require("../../OpenAI/components/Mono"));
var import_IconCombine = __toESM(require("../../features/IconCombine"));
var import_style = require("../style");
var import_Text = __toESM(require("./Text"));
var Combine = (0, import_react.memo)(({ extraStyle, size = 24, ...rest }) => {
  return /* @__PURE__ */ React.createElement(
    import_IconCombine.default,
    {
      ...
      extraStyle: {
        fontSize: size * 0.85,
        marginLeft: size * import_style.COMBINE_SPACE_MULTIPLE,
        ...extraStyle
      },
      size,

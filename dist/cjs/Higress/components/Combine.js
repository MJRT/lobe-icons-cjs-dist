...
var import_TextColor = __toESM(require("./TextColor"));
var Combine = (0, import_react.memo)(({ type = "mono", ...rest }) => {
  return type === "color" ? /* @__PURE__ */ React.createElement(import_TextColor.default, { ...rest }) : /* @__PURE__ */ React.createElement(import_Text.default, { ...rest });
});

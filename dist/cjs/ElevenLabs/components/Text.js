...
// src/ElevenLabs/components/Text.tsx
var Text_exports = {};
...
var Icon = (0, import_react.memo)(({ size = "1em", style, ...rest }) => {
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("path", { d: "M159.359 17.818h4.293c.061 1.697.975 2.515 2.588 2.515 1.614 0 2.528-.727 2.528-2 0-1.151-.701-1.575-2.223-1.94l-1.31-.332c-3.714-.94-5.572-1.94-5.572-5 0-3.061 2.863-5 6.516-5 3.654 0 6.425 1.424 6.547 4.787h-4.293c-.092-1.484-1.005-2.12-2.314-2.12-1.31 0-2.223.636-2.223 1.848 0 1.12.731 1.545 2.009 1.848l1.34.334c3.532.878 5.755 1.757 5.755 5.03 0 3.273-2.923 5.212-6.881 5.212-4.294 0-6.669-1.606-6.76-5.182z" })
  );
});
